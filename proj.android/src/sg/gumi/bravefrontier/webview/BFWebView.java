...
final public class BFWebView implements android.view.View$OnTouchListener, android.view.View$OnClickListener {
    ...
    public static void playYoutubeVideo(String s) {
        sg.gumi.bravefrontier.webview.BFWebView.getInstance().playYoutubeVideoHelper(s);
    }
    ...
    public static void setWebViewVisible(boolean b) {
        sg.gumi.bravefrontier.webview.BFWebView.getInstance().setWebViewVisibleHelper(b);
    }
