...
class BraveFrontierJNI$7 implements Runnable {
    ...
    public void run() {
        android.content.Context a = ((android.app.Activity)sg.gumi.bravefrontier.BraveFrontierJNI.access$000()).getApplicationContext();
        android.app.AlertDialog$Builder a0 = new android.app.AlertDialog$Builder((android.content.Context)sg.gumi.bravefrontier.BraveFrontierJNI.access$000());
        ...
        if (sg.gumi.util.BFConfig.PLATFORM != sg.gumi.util.BFConfig.PLATFORM_AMAZON) {
            ...
            a0.setMessage((CharSequence)(Object)sg.gumi.bravefrontier.BraveFrontierJNI.access$100(this.val$body, "Amazon Appstore", "Amazon"));
        }
